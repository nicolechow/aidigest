...
# 或手动安装
git clone https://github.com/nicolechow/aidigest.git ~/skills/follow-builders
cd ~/skills/follow-builders/scripts && npm install
```

### Claude Code
```bash
git clone https://github.com/nicolechow/aidigest.git ~/.claude/skills/follow-builders
