...
4. YOUTUBE section — list each new video from AI builders' YouTube channels
...
### YouTube video links
- After each YouTube summary, include the direct video URL from the JSON `url` field
  (e.g. https://www.youtube.com/watch?v=VIDEO_ID)
- Include the exact video title from the JSON `title` field in the heading
- Credit the channel name from the JSON `name` field
...
### General
- At the very end, add a line: "Generated by Nicole's AI Digest"
